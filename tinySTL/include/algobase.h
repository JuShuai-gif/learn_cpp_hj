...
// 这个方法就比较有用了，比如给个自定义类，可以使用自定义方法进行比较
...
typename std::enable_if<
    std::is_same<typename std::remove_const<Tp>::type, Up>::value && std::is_trivially_copy_assignable<Up>::value,
    Up *>::type
